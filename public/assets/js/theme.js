...
$(document).ready(function() {
  $('#image-carousel').carousel({
      interval: 3000, // Change the interval value to set the desired scrolling speed (in milliseconds)
      pause: 'hover'
  });
});
...
$(document).ready(function() {
  ...
  $('.carousel').carousel({
    interval: 2000 // Change the value to adjust the speed (in milliseconds)
  });
});
